              ...
              <Route
                ...
                render={({ match }) => {
                  ...
                  if (isAddress(match.params.tokenAddress.toLowerCase())) {
                    return <TokenPage address={match.params.tokenAddress.toLowerCase()} />
                  } else {
                    return <Redirect to="/home" />
                  }
                }}
              ...
              <Route
                ...
                render={({ match }) => {
                  ...
                  if (isAddress(match.params.pairAddress.toLowerCase())) {
                    return <PairPage pairAddress={match.params.pairAddress.toLowerCase()} />
                  } else {
                    return <Redirect to="/home" />
                  }
                }}
              ...
              <Route
                ...
                render={({ match }) => {
                  if (isAddress(match.params.accountAddress.toLowerCase())) {
                    return <AccountPage account={match.params.accountAddress.toLowerCase()} />
                  } else {
                    return <Redirect to="/home" />
                  }
                }}
